                  ...
                  <tr key={s.id} className="hover:bg-ink-850/60">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-1.5 text-slate-400">
                        <button title="Backtest" className="hover:text-accent-soft" onClick={() => router.push(`/strategy/${s.id}`)}>
                          <LineChart className="w-4 h-4" />
                        </button>
                        <button title="Edit" className="hover:text-accent-soft" onClick={() => router.push(`/builder/${s.id}`)}>
