...
import { createIndicator, indicatorSignature } from '../src/server/services/indicator/registry';
import type { Bar, Indicator } from '../src/server/services/indicator/types';
